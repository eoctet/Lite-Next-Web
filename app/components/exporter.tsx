...
import { DEFAULT_BOT_AVATAR } from "../store/bot";
...
function ExportAvatar(props: { avatar: string }) {
  if (props.avatar === DEFAULT_BOT_AVATAR) {
    return (
      <img
        src={BotIcon.src}
        width={30}
    ...
    <div className={styles["image-previewer"]}>
      ...
      >
        <div className={styles["chat-info"]}>
          <div>
            <div className={styles["main-title"]}>Octet.Chat</div>
            <div className={styles["sub-title"]}>
            Build your own private auto agent.
            </div>
            <div className={styles["icons"]}>
              <ExportAvatar avatar={config.avatar} />
              <span className={styles["icon-space"]}>&</span>
              <ExportAvatar avatar={bot.avatar} />
            </div>
          </div>
          <div>
          ...
          return (
            ...
            >
              <div className={styles["avatar"]}>
                <ExportAvatar
                  avatar={m.role === "user" ? config.avatar : bot.avatar}
                />
              </div>
